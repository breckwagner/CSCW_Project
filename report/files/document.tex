...
\toappear{
	\includegraphics[scale=0.5]{assets/by}
...
\def\plainauthor{Arturo Reyes Lopez, Nitin Goyal, Richard B. Wagner, Tim Baker, Alastair Beaumont}
\def\emptyauthor{}
\def\plainkeywords{Gamification; StackOverflow (SO)}
\def\plaingeneralterms{Human-Computer Interaction, Computer Supported Collaborative Work}
...
\nocite{*}  % Include all citations in References section
